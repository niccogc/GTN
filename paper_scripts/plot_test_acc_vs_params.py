...
MNIST_DIR = Path("/home/nicci/Desktop/remote/GTN/outputs/gtn/MNIST/CMPO2")
FASHION_DIR = Path("/home/nicci/Desktop/remote/GTN/outputs/gtn/FASHION_MNIST/CMPO2")
CNN_MNIST_DIR = Path("/home/nicci/Desktop/remote/GTN/outputs/cnn/MNIST/BaselineCNN_rg0_init0")
OUTPUT_PATH = Path("/home/nicci/Desktop/remote/GTN/paper_scripts/images/test_acc_vs_params.pdf")
...
def plot_dataset(ax, cmpo2_data, cpd_data, tnml_data, title):
    ...
    ax.plot(cpd_params, cpd_acc, "s-", color="#ff7f0e", markersize=6, linewidth=1.5, label="CPD")
    ax.plot(tnml_params, tnml_acc, "^-", color="#2ca02c", markersize=6, linewidth=1.5, label="TNML")
...
plot_dataset(ax1, mnist_cmpo2, cpd_mnist, tnml_mnist, "MNIST")
plot_dataset(ax2, fashion_cmpo2, cpd_fashion, tnml_fashion, "Fashion-MNIST")
