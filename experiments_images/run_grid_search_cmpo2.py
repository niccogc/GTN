...
from utils.config_parser import load_config, create_experiment_plan, print_experiment_summary
from experiments_images.image_dataset_loader import load_image_dataset
from utils.trackers import create_tracker, TrackerError
...
def create_experiment_plan_cmpo2(config: dict):
    from utils.config_parser import expand_parameter_grid
