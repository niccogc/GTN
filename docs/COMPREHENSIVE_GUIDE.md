...
python -c "from utils.dataset_loader import load_dataset; d, i = load_dataset('iris'); print(f'✓ Loaded {i[\"name\"]} dataset')"
```
...
```python
from utils.config_parser import load_config, create_experiment_plan
