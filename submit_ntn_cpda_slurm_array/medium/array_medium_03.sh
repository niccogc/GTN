...
#SBATCH --output=logs/ntn-medium_03_%A_%a.out
#SBATCH --error=logs/ntn-medium_03_%A_%a.err
...
python run.py --multirun +experiment=cpda_ntn_sweep model=$MODEL dataset=$DATASET
