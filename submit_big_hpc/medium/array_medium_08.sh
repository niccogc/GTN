#!/bin/bash
#SBATCH --job-name=ntn-medium_08
#SBATCH --output=/home/nicci/logs/ntn-medium_08_%A_%a.out
#SBATCH --error=/home/nicci/logs/ntn-medium_08_%A_%a.err
...
PARAMS_FILE="$SLURM_SUBMIT_DIR/params_medium_08.txt"
