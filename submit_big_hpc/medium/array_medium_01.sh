#!/bin/bash
#SBATCH --job-name=ntn-medium_01
#SBATCH --output=/home/nicci/logs/ntn-medium_01_%A_%a.out
#SBATCH --error=/home/nicci/logs/ntn-medium_01_%A_%a.err
...
PARAMS_FILE="$SLURM_SUBMIT_DIR/params_medium_01.txt"
