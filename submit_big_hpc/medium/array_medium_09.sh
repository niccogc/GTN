#!/bin/bash
#SBATCH --job-name=ntn-medium_09
#SBATCH --output=/home/nicci/logs/ntn-medium_09_%A_%a.out
#SBATCH --error=/home/nicci/logs/ntn-medium_09_%A_%a.err
...
PARAMS_FILE="$SLURM_SUBMIT_DIR/params_medium_09.txt"
...
python run.py --multirun trainer=ntn model=$MODEL dataset=$DATASET
