#!/bin/bash
#SBATCH --job-name=ntn-medium_12
#SBATCH --output=/home/nicci/logs/ntn-medium_12_%A_%a.out
#SBATCH --error=/home/nicci/logs/ntn-medium_12_%A_%a.err
...
PARAMS_FILE="$SLURM_SUBMIT_DIR/params_medium_12.txt"
