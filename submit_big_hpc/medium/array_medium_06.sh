#!/bin/bash
#SBATCH --job-name=ntn-medium_06
#SBATCH --output=/home/nicci/logs/ntn-medium_06_%A_%a.out
#SBATCH --error=/home/nicci/logs/ntn-medium_06_%A_%a.err
...
PARAMS_FILE="$SLURM_SUBMIT_DIR/params_medium_06.txt"
