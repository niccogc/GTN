#!/bin/bash
#SBATCH --job-name=ntn-medium_07
#SBATCH --output=/home/nicci/logs/ntn-medium_07_%A_%a.out
#SBATCH --error=/home/nicci/logs/ntn-medium_07_%A_%a.err
...
PARAMS_FILE="$SLURM_SUBMIT_DIR/params_medium_07.txt"
