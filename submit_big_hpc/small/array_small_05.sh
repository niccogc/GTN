#!/bin/bash
#SBATCH --job-name=ntn-small_05
#SBATCH --output=/home/nicci/logs/ntn-small_05_%A_%a.out
#SBATCH --error=/home/nicci/logs/ntn-small_05_%A_%a.err
...
PARAMS_FILE="$SLURM_SUBMIT_DIR/params_small_05.txt"
