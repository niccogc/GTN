#!/bin/bash
#SBATCH --job-name=ntn-small_01
#SBATCH --output=/home/nicci/logs/ntn-small_01_%A_%a.out
#SBATCH --error=/home/nicci/logs/ntn-small_01_%A_%a.err
...
PARAMS_FILE="$SLURM_SUBMIT_DIR/params_small_01.txt"
