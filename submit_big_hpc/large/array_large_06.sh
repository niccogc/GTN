#!/bin/bash
#SBATCH --job-name=ntn-large_06
#SBATCH --output=/home/nicci/logs/ntn-large_06_%A_%a.out
#SBATCH --error=/home/nicci/logs/ntn-large_06_%A_%a.err
...
PARAMS_FILE="$SLURM_SUBMIT_DIR/params_large_06.txt"
