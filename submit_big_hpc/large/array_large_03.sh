#!/bin/bash
#SBATCH --job-name=ntn-large_03
#SBATCH --output=/home/nicci/logs/ntn-large_03_%A_%a.out
#SBATCH --error=/home/nicci/logs/ntn-large_03_%A_%a.err
...
PARAMS_FILE="$SLURM_SUBMIT_DIR/params_large_03.txt"
