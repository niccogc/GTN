#!/bin/bash
# Bash wrapper for MMPO2 training with environment variable configuration
...
# Output
export OUTPUT_FILE="${OUTPUT_FILE:-results_mmpo2.json}"
...
export EXPERIMENT_NAME="${EXPERIMENT_NAME:-mmpo2_experiment}"

# Run training
python experiments/train_mmpo2.py
