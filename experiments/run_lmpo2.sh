#!/bin/bash
# Bash wrapper for LMPO2 training with environment variable configuration
...
export REDUCTION_FACTOR="${REDUCTION_FACTOR:-0.5}"
...
# Output
export OUTPUT_FILE="${OUTPUT_FILE:-results_lmpo2.json}"
...
export EXPERIMENT_NAME="${EXPERIMENT_NAME:-lmpo2_experiment}"

# Run training
python experiments/train_lmpo2.py
