#!/bin/bash
#SBATCH --job-name=gtn-lmpo2-seoulBike
#SBATCH --output=/home/nicci/GTN/logs/gtn-lmpo2-seoulBike_%J.out
#SBATCH --error=/home/nicci/GTN/logs/gtn-lmpo2-seoulBike_%J.err
