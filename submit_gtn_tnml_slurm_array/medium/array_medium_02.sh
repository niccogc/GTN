#!/bin/bash
#SBATCH --job-name=gtn-medium_02
#SBATCH --output=logs/gtn-medium_02_%A_%a.out
#SBATCH --error=logs/gtn-medium_02_%A_%a.err
...
python run.py --multirun +experiment=uci_gtn_sweep model=$MODEL dataset=$DATASET
